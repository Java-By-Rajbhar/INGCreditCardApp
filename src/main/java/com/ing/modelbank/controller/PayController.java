...
public class PayController {
	...
	public ResponseEntity<PayResponseDto> payNow(@PathVariable long customerId,CreditCardRequestDto creditCardRequestDto)
	{
		logger.info("inside payNow method of PayController class");
		PayResponseDto response = payServiceImpl.pay(customerId, creditCardRequestDto);
